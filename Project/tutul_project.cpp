...
void river()
{
    ...
    // Sleepers for both tracks
    for(int x=0; x<=1800; x+=60)
    {
        // Track 1 sleepers
        glColor3ub(95,65,45);
        glBegin(GL_POLYGON);
    ...
    // Support pillars under tracks
    for(int px=100; px<1800; px+=300)
    {
        glColor3ub(85,85,85);
        glBegin(GL_POLYGON);
          glVertex2f(px, 0);
          glVertex2f(px+30, 0);
          glVertex2f(px+30, 220);
          glVertex2f(px, 220);
        glEnd();
    }
}
...
void boat(){
    float trackY = 225; // place metro exactly on track1
    float bh = 50;
    float bx = 100;  // X start
    float bodyW = 400;

    // Coach body
    glColor3ub(196, 30, 58);
    glBegin(GL_POLYGON);
      glVertex2f(bx, trackY);
      glVertex2f(bx+bodyW, trackY);
      glVertex2f(bx+bodyW, trackY+bh);
      glVertex2f(bx, trackY+bh);
    glEnd();
